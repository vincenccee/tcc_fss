...
Os \textit{Hyperplane-defined Functions} (HDFs) foram projetados para representar a forma como as pesquisas do GA ocorrem, através da combinação da construção de blocos.

baseia-se no HDF - \cite{holland2000building}
