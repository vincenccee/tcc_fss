...
$F_{Ackley}(x) = -20 \exp \left(-0.2 \sqrt{\frac{1}{n} \sum_{i=0}^{n} x_i^2 }\right) - \exp$ & \raisebox{-.5\height}{\includegraphics[scale=0.28]{images/f_ackley.png}} \\ \hline
...
\multirow{2}{*}{Funções} & \multicolumn{5}{c|}{Valor de Fitness e desvio padrão}                                                                                                                                                                                                                                                                        \\ \cline{2-6} 
                         & Orig. PSO                                                   & \begin{tabular}[c]{@{}c@{}}Constricted\\ PSO(Gbest)\end{tabular} & \begin{tabular}[c]{@{}c@{}}Constricted\\ PSO(Lbest)\end{tabular} & Autor FSS                                                & FSS Próprio                                                   \\ \hline
