...
\begin{table}[]
	...
	\begin{tabular}{|c|c|c|c|}
		...
		Rosembrock & 0.001 & \raisebox{-.5\height}{\includegraphics[scale=0.35]{images/p_rosem}} & \raisebox{-.5\height}{\includegraphics[scale=0.35]{images/d_rosem}} \\ \hline
		...
		Griewank  &  & \raisebox{-.5\height}{\includegraphics[scale=0.35]{images/pop_diversity}} & \raisebox{-.5\height}{\includegraphics[scale=0.35]{images/pop_diversity}} \\ \hline
		Ackley  &  & \raisebox{-.5\height}{\includegraphics[scale=0.35]{images/pop_diversity}} & \raisebox{-.5\height}{\includegraphics[scale=0.35]{images/pop_diversity}} \\ \hline
		Schafel 1,2  &  & \raisebox{-.5\height}{\includegraphics[scale=0.35]{images/pop_diversity}} & \raisebox{-.5\height}{\includegraphics[scale=0.35]{images/pop_diversity}} \\ \hline
	\end{tabular}
\end{table}
